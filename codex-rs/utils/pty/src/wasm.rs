...
impl ProcessHandle {
    ...
    pub fn signal(&self, signal: ProcessSignal) -> io::Result<()> {
        match signal {
            ProcessSignal::Interrupt => Err(io::Error::new(
                io::ErrorKind::Unsupported,
                "browser process interrupt requires an almostnode process host shim",
            )),
        }
    }
...
pub async fn spawn_pipe_process(
    ...
    let _ = (program, args, cwd, env, arg0, inherited_fds);
...
pub async fn spawn_pty_process(
    ...
    let _ = (program, args, cwd, env, arg0, size, inherited_fds);
    unsupported_spawn().await
}
...
pub mod pipe {
    ...
    pub async fn spawn_process(
        ...
        super::spawn_pipe_process(program, args, cwd, env, arg0, inherited_fds).await
    }
    ...
    pub async fn spawn_process_no_stdin(
        ...
        super::spawn_pipe_process_no_stdin(program, args, cwd, env, arg0, inherited_fds).await
    }
...
pub mod pty {
    ...
    pub async fn spawn_process(
        ...
        super::spawn_pty_process(program, args, cwd, env, arg0, size, inherited_fds).await
    }
