pub const CODEX_APP_DIRECTORY_CACHE_ATTACHMENT_FILENAME: &str =
    "codex-app-directory-cache.json";
pub const CODEX_APPS_TOOLS_CACHE_ATTACHMENT_FILENAME: &str =
    "codex-apps-tools-cache.json";
