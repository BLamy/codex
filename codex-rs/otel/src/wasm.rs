...
impl SessionTelemetry {
    ...
    pub fn with_inference_request<ReasoningEffort>(
        self,
        _service_tier: Option<&str>,
        _model_reasoning_effort: Option<&ReasoningEffort>,
    ) -> Self {
        self
    }
    ...
    #[allow(clippy::too_many_arguments)]
    pub fn record_api_request<AgentIdentityTelemetry>(
        &self,
        _attempt: u64,
        _status: Option<u16>,
        _error: Option<&str>,
        ...
        _agent_identity_telemetry: Option<&AgentIdentityTelemetry>,
    ) {
    }

    #[allow(clippy::too_many_arguments)]
    pub fn record_websocket_connect<AgentIdentityTelemetry>(
        &self,
        _duration: Duration,
        _status: Option<u16>,
        _error: Option<&str>,
    ...
    pub fn record_websocket_request<AgentIdentityTelemetry>(
        &self,
        _duration: Duration,
        _error: Option<&str>,
        _connection_reused: bool,
    ...
    pub fn sse_event_completed<TokenUsage>(&self, _usage: &TokenUsage, _ttft_ms: Option<i64>) {}
...
impl From<codex_protocol::auth::AuthMode> for TelemetryAuthMode {
    fn from(mode: codex_protocol::auth::AuthMode) -> Self {
        match mode {
            codex_protocol::auth::AuthMode::ApiKey
            | codex_protocol::auth::AuthMode::BedrockApiKey => Self::ApiKey,
            ...
            | codex_protocol::auth::AuthMode::PersonalAccessToken => Self::Chatgpt,
        }
    }
}
